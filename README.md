...
phrase to an **ISO-8601** date — trained **entirely on data generated by code**. No
scraping, no labelling, no distillation from a larger model. It runs on a CPU in
milliseconds and trains from scratch in ~30 seconds on one GPU.
...
- **Model on Hugging Face:** https://huggingface.co/vukrosic/nano-dates
- **Write-up:** https://opensuperintelligencelab.com/blog/nano-dates
...
python -c "from modeling_nano_dates import load, parse; m=load(); print(parse(m,'2024-03-10','in 3 weeks'))"
# -> 2024-03-31
```
